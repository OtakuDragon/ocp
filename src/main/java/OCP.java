...
public class OCP {
       ...
       /*
        ...
        DateFormat dateFormat = DateFormat.getDateTimeInstance(DateFormat.SHORT, locale);
    ...
    public synchronized static void main(String[] args) throws IOException, CloneNotSupportedException, InterruptedException, SQLException, ParseException {
        ...
        String string = "123.547";

        System.out.println(numberFormat.parse(string));
        System.out.println(numberFormat.format(numberFormat.parse(string)));
